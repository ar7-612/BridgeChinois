...
public class VueGraphique extends JFrame implements InterfaceUtilisateur , ActionListener {
    ...
    private void refaireCoup(){
        if(j.peutRefaire()){
            if(j.quiJoue() == 1){
                Carte carte;
                boolean tourJ1 = j.quiJoue() == 1;
                if(j.quiDonne() == 1) {
                	carte=j.cartePrem();
                } else {
                	carte=j.carteSec();
                }
                carteJ1.setIcon(new ImageIcon(getClass().getResource("/images/cartes/"+afficherCarte(carte)+".png")));
                for(int i=0;i<11;i++) {
                   	JLabel label;
                   	switch(i) {
                   	...
                   	if(j.joueurDonneur().main().carte(i)!=null && afficherCarte(carte).equals(afficherCarte(j.joueurDonneur().main().carte(i)))){
                       	label.setIcon(null);
                    }
                }
            } else {
                if(j.quiDonne() == 2){
                    carteJ2.setIcon(new ImageIcon(getClass().getResource("/images/cartes/"+afficherCarte(j.cartePrem())+".png")));
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(0)))){
                        J2c1.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(1)))){
                        J2c2.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(2)))){
                        J2c3.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(3)))){
                        J2c4.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(4)))){
                        J2c5.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(5)))){
                        J2c6.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(6)))){
                        J2c7.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(7)))){
                        J2c8.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(8)))){
                        J2c9.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(9)))){
                        J2c10.setIcon(null);
                    }
                    if(afficherCarte(j.cartePrem()).equals(afficherCarte(j.joueurDonneur().main().carte(10)))){
                        J2c11.setIcon(null);
                    }
                } else {
                    carteJ2.setIcon(new ImageIcon(getClass().getResource("/images/cartes/"+afficherCarte(j.carteSec())+".png")));
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(0)))){
                        J2c1.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(1)))){
                        J2c2.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(2)))){
                        J2c3.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(3)))){
                        J2c4.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(4)))){
                        J2c5.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(5)))){
                        J2c6.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(6)))){
                        J2c7.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(7)))){
                        J2c8.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(8)))){
                        J2c9.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(9)))){
                        J2c10.setIcon(null);
                    }
                    if(afficherCarte(j.carteSec()).equals(afficherCarte(j.joueurReceveur().main().carte(10)))){
                        J2c11.setIcon(null);
                    }
                }
            }
