...
public class VueGraphique extends JFrame implements InterfaceUtilisateur , ActionListener {
    ...
    private void refaireCoup(){
        if(j.peutRefaire()){
            if(j.quiJoue() == 1){
                if(j.quiDonne() == 1){
                    carteJ1.setIcon(new ImageIcon(getClass().getResource("/images/cartes/"+afficherCarte(j.cartePrem())+".png")));
                    ...
                    carteJ1.setIcon(new ImageIcon(getClass().getResource("/images/cartes/"+afficherCarte(j.carteSec())+".png")));
